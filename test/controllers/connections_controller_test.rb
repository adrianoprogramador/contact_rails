...
class ConnectionsControllerTest < ActionController::TestCase
  ...
  test "should create connection" do
    assert_difference('Connection.count') do
      post :create, connection: { email: @connection.email, kind_id: @connection.kind_id, name: @connection.name, remark: @connection.remark }
    end
  ...
  test "should update connection" do
    patch :update, id: @connection, connection: { email: @connection.email, kind_id: @connection.kind_id, name: @connection.name, remark: @connection.remark }
    assert_redirected_to connection_path(assigns(:connection))
  end
